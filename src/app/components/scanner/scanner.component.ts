  ...
  template: `
    ...
    >
      <img
        ...
        [src]="imgSrc"
        alt="scanner-logo"
        class="animate-pulse w-24 h-24 mr-2"
      />
      ...
      <p class="hidden lg:block text-xs">
        Please switch to mobile device for scaning
      </p>
    </div>
    @if (scanResult()) {
    <div class="text-md">Scanned Code: {{ scanResult() }}</div>
      }
  `,
  styles: [],
})
export class ScannerComponent {
  ...
  imgSrc =
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNNwwYmJqXpNhP8qmCNmQ36vBimXqMdW67aQ&s';
